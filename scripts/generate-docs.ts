...
async function generateDocs(): Promise<void> {
  ...
  const result = Object.entries(rules).map(async ([ruleName, rule]) => {
    ...
    if (graphQLJSRuleName) {
      ...
      blocks.push(
        `- [Rule source](https://github.com/graphql-hive/graphql-eslint/tree/master/packages/plugin/src/rules/${ruleName}.ts)`,
        `- [Test source](https://github.com/graphql-hive/graphql-eslint/tree/master/packages/plugin/__tests__/${ruleName}.spec.ts)`,
      );
    }
    return {
