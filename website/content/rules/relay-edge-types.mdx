...
- [Rule source](https://github.com/graphql-hive/graphql-eslint/tree/master/packages/plugin/src/rules/relay-edge-types/index.ts)
- [Test source](https://github.com/graphql-hive/graphql-eslint/tree/master/packages/plugin/src/rules/relay-edge-types/index.test.ts)
