...
- [Rule source](https://github.com/graphql-hive/graphql-eslint/tree/master/packages/plugin/src/rules/require-selections/index.ts)
- [Test source](https://github.com/graphql-hive/graphql-eslint/tree/master/packages/plugin/src/rules/require-selections/index.test.ts)
