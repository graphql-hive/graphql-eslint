...
- [Rule source](https://github.com/graphql-hive/graphql-eslint/tree/master/packages/plugin/src/rules/require-description/index.ts)
- [Test source](https://github.com/graphql-hive/graphql-eslint/tree/master/packages/plugin/src/rules/require-description/index.test.ts)
