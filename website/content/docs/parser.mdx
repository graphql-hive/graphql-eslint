...
title: How Does a GraphQL-ESLint Parser Work?
---
...
behaviour using `skipGraphQLConfig: true` in the `parserOptions`).
...
[You can find more detail on the `parserOptions` config here](/docs/usage#providing-graphql-schema-optional).
