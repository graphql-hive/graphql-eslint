...
We recommend you to read the [graphql-eslint parser documentation](/docs/parser) before getting
...
(you can read more about that in [graphql-eslint parser documentation](/docs/parser)).
